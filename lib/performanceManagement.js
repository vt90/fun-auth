import {splitInterval} from "./utils";
...
export const extractPerformanceDataFromReport = (currentReport, previousReport) => {
    ...
    return currentReport
        .map((currentReviewInfo) => {
            ...
            if (!domainPositionMap[domainRatingKey]) {
                domainPositionMap[domainRatingKey] = 0;
            }
        ...
        .map(([currentRating, entry]) => {
            ...
            if (domainRatingMap[domainRatingKey] === 1) {
                ...
                ratingPosition = domainRatingInterval[domainPositionMap[domainRatingKey]];
                domainPositionMap[domainRatingKey] ++;
            }
